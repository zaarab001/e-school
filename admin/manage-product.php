...
<div class="chit-chat-layer1">
	<div class="col-md-12 chit-chat-layer1-left">
               <div class="work-progres">
					...
					$pic = $row['image'];
					$check_pic = "admin/images/product/$pic";
					$default_pic = "admin/images/product/default_pic.jpg";
					...
					if (file_exists($check_pic)) {
						$pro_pic = "<img src=\"$check_pic?\" width=\"50px\" height=\"50px\" />";
						// forces picture to be 50px wide and no more
					} else {
						$pro_pic = "<img src=\"$default_pic\" width=\"50px\" height=\"50px\" />"; // forces default picture to be 100px wide and no more
					}
