					...
					<div class="inbox-details-default">
						...
						<div class="inbox-details-body">
							<div class="alert alert-info">
								Please fill details to edit Applicant's Personal Informantion.
							</div>
							<form class="com-mail" action="" method="post" enctype="multipart/form-data">
								<input type="text"  value="Applicant Name :" name="applicant_name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Full Name';}">
                                <input type="text"  value="Mobile Number :" name="mobile" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile Number';}">
								<input type="text"  value="Date of Birth :" name="dob" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Date of Birth';}">
								<input type="text"  value="Gender :" name="gender" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Gender';}">
