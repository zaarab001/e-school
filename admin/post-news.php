					...
					<div class="inbox-details-default">
						...
						<div class="inbox-details-body">
							<div class="alert alert-info">
								Please fill details to Upload News
							</div>
							...
							<form class="com-mail" action="" method="post" enctype="multipart/form-data">
								...
								<textarea rows="6" name="content"  value="Content :" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Content';}">Content : </textarea>
								...
								<input type="submit" name="upload_news" value="Upload News"> 
							</form>
						</div>
					</div>
				</div>
