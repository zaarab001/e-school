    	 	...
    	 	<div class="col-md-8 compose-right">
					<div class="inbox-details-default">
						<div class="inbox-details-heading">
							Staffs Registeration Panel 
						</div>
						<div class="inbox-details-body">
							<div class="alert alert-info">
								Please fill details to Register Staffs
							</div>
                            <?php include ('includes/_staff.php');?>
							<form class="com-mail" action="" method="post" enctype="multipart/form-data">
								<input type="text"  value="Full Name :" name="fullname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Full Name';}">
								<input type="text"  value="Email :" name="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}">
                                <input type="text"  value="Mobile Number :" name="mobile" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile Number';}">
								<select name="position" class="form-control m-bot15">
                                    <option name="position" value="non">** Select Position of Staff **</option>
                                    <option name="position" value="Director">Director</option>
                                    <option name="position" value="Manager">Manager</option>
                                    <option name="position" value="Driving Tutor">Driving Tutor</option>
                                    <option name="position" value="Herbal Tutor">Herbal Tutor</option>
                                 </select><br>
								...
								<div class="form-group">
									<div class="btn btn-default btn-file">
										<i class="fa fa-paperclip"> </i> Passport :
										<input type="file" name="image">
									</div>
								</div>
								<input type="submit" name="r_staffs" value="Register"> 
							</form>
						</div>
					</div>
				</div>
