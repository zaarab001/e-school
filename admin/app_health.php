					...
					<div class="inbox-details-default">
						...
						<div class="inbox-details-body">
							<div class="alert alert-info">
								Please fill details to edit Applicant's Health Informantion.
							</div>
							<form class="com-mail" action="" method="post">
								<input type="text"  value="Blood Group :" name="blood_g" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Blood Group';}">
                                <input type="text"  value="Record of Medical Fitness :" name="record_mf" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Record of Medical Fitness';}">
								<input type="text"  value="Facial Mark. Height :" name="facial_mh" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Date of Birth';}">
											
								<input type="submit" name="update_app_health" value="Update"> 
							</form>
						</div>
					</div>
				</div>
