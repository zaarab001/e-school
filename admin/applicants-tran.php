	...
	<div class="col-md-12 chit-chat-layer1-left">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                  <br><br>Applicants Payment Comfirmation
                            </div><br>
                            <div class="table-responsive">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>HAMDASA/DRI/18/001</td>                                 
                                  <td><img src="images/pro8.jpg" width="200px" height="100px"></td>
                                   <td>
                                    <a class="btn btn-success" href="" title="Accept Payment"><i class="icon_plus"></i></a>
                                    <a class="btn btn-danger" href="" title="Decline Payment"><i class="icon_close"></i></a>
                      			  </td>
                              </tr>
                              <tr>
                                  <td>2</td>
                                  <td>Memunat Manzuma</td>
                                  <td>HAMDASA/HERB/18/001</td>                                 
                                  <td><img src="images/pro8.jpg" width="200px" height="100px"></td>
                                   <td>
                                    <a class="btn btn-success" href="" title="Accept Payment"><i class="icon_plus_alt2"></i></a>
                                    <a class="btn btn-danger" href="" title="Decline Payment"><i class="icon_close_alt2"></i></a>
                      			  </td>
                              </tr>
                              <tr>
                                  <td>3</td>
                                  <td>Memunat Manzuma</td>
                                 <td>HAMDASA/DRI/18/002</td>                                 
                                 <td><img src="images/pro8.jpg" width="200px" height="100px"></td>
                                   <td>
                                    <a class="btn btn-success" href="" title="Accept Payment"><i class="icon_plus_alt2"></i></a>
                                    <a class="btn btn-danger" href="" title="Decline Payment"><i class="icon_close_alt2"></i></a>
                              ...
                              <tr>
                                 <td>4</td>
                                  <td>Memunat Manzuma</td>
                                  <td>HAMDASA/HERB/18/002</td>                                 
                                  <td><img src="images/pro8.jpg" width="200px" height="100px"></td>
                                   <td>
                                    <a class="btn btn-success" href="" title="Accept Payment"><i class="icon_plus_alt1"></i></a>
                                    <a class="btn btn-danger" href="" title="Decline Payment"><i class="icon_close_alt1"></i></a>
                      			  </td>
                              </tr>
                          </tbody>
                      </table>
